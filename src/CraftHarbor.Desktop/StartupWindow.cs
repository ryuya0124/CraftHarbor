...
public sealed class StartupWindow : Window
{
    ...
    {
        Title = "CraftHelm — 準備中"; Width = 460; Height = 260;
        ...
        row.Children.Add(new TextBlock { Text = "CraftHelm", FontSize = 26, FontWeight = FontWeights.Bold }); panel.Children.Add(row);
